...
from werkzeug.utils import secure_filename # Make sure to import this for secure filenames
...
def add_project():
    if request.method == 'POST':
        ...
        if not title or not description:
            ...
            return render_template('add_project.html', title=title, description=description, url=url, year=year)
